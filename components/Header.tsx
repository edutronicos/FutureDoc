        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            ...
            <span className="ml-3 text-xl font-serif font-bold text-navy-900 tracking-tight">
              FutureDoc<span className="text-gold-500">.AI</span>
            </span>
          </div>
          <div className="flex items-center space-x-4">
             <div className="hidden md:flex flex-col items-end mr-2">
                <span className="text-sm font-medium text-slate-700">Dr. Alexandre Silva</span>
                <span className="text-xs text-slate-500">Sócio Sênior</span>
             </div>
